...
try {
  ...
  ; (() => {
    ...
    const turnCaptionsOn = () => {
      const captionsButtonOn = xpath(`//*[@id="ow3"]/div[1]/div/div[12]/div[3]/div[10]/div[2]/div/div[3]/span/button/span[1]`, document);
      if (captionsButtonOn) {
    ...
    const turnCaptionsOff = () => {
      const captionsButtonOff = xpath(`//*[@id="ow3"]/div[1]/div/div[12]/div[3]/div[10]/div[2]/div/div[3]/span/button/span[2]`, document);
    ...
    const getMeetingName = () => {
      const name = xpath(`//*[@id="ow3"]/div[1]/div/div[12]/div[3]/div[10]/div[1]/div/div/div/span/div[1]`);
  ...
  `;
    ...
    const XPATH_SELECTOR_PARTICIPANTS = '//*[@id="ow3"]/div[1]/div/div[12]/div[3]/div[10]/div[3]/div[3]/div/div/div[2]/span/button/i[1]';
    const XPATH_SELECTOR_CHAT = `//*[@id="ow3"]/div[1]/div/div[12]/div[3]/div[10]/div[3]/div[3]/div/div/div[3]/span/button/i[1]`;
  })();
