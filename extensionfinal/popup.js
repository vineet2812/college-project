...
updateState = () => {
    ...
    if (token !== null && token !== undefined) {
        fetch('https://mme-ava.herokuapp.com/api/current_user/', {
            headers: {
            ...
            .then(json => {
                ...
                if (json === undefined || json.email === '' || json.email === undefined) {
                    ...
                    extensionState.name = '';
                    loginContainerContent = ' <a href="https://priceless-bassi-1c5830.netlify.app/login" target="_blank">Login</a> ';
                }
                else {
                    // If token is correct
                    ...
                    loginContainerContent += `<p> <a href="https://priceless-bassi-1c5830.netlify.app/dashboard" target="_blank">View Dashboard</a> </p>`;
                }
